...
# web camera
nama_file = 'video_dago.mp4'

cap = cv2.VideoCapture(nama_file)

min_width_rectangle = 100 # rectangle width
min_height_rectangle = 100 # rectangle height
max_width_rectangle = 275 # rectangle width
max_height_rectangle = 275 # rectangle height
...
detect = []
offset=2 #allowable error between pixel
counter=0
